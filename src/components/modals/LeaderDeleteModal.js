...
const LeaderDeleteModal = ({ open, onClose, leader, onDelete, loading }) => {
    ...
    <Dialog open={open} onClose={handleClose} fullWidth maxWidth="sm">
      ...
      <DialogContent>
        ...
        <Typography sx={{ mb: 2 }}>
          ...
          <strong>{leader.nombre} {leader.apellido}</strong> con ID{" "}
          <strong>{leader.identificacion}</strong>?
        </Typography>

        <Alert severity="info" sx={{ mb: 2 }}>
          <Typography variant="caption">
            Nota: Las asignaciones de votantes a este líder se mantendrán en el historial.
          </Typography>
        </Alert>
        ...
        <TextField
          ...
          placeholder="Ej: Duplicado, Renuncia, Error de registro, etc."
...
export default LeaderDeleteModal;
